        ...
        <header className="displayed-content py-4">
            <div className="d-flex flex-row justify-content-around flex-wrap">
                <div className="d-flex flex-row justify-content-center flex-wrap">
                    ...
                    <div className="navbar-button mx-3" style={props.location === "changedSpecial" ? { color: "white" } : {}} onClick={() => props.setLocation('changedSpecial')}>{props.locale.navbar.changedSpecial}</div>
                    <div className="navbar-button mx-3" style={props.location === "about" ? { color: "white" } : {}} onClick={() => props.setLocation('about')}>{props.locale.navbar.about}</div>
                </div>
                <div className="d-flex flex-row justify-content-center flex-wrap">
